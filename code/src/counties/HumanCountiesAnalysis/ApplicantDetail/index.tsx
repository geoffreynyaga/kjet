...
import { LoadingState, ErrorState } from './LoadingAndErrorStates.tsx';
  ...
  return (
    <div className="relative min-h-screen overflow-hidden ">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col w-full p-8 space-x-4 justify-evenly lg:flex-row ">
            {/* Left Column - Data (80%) */}
            <div className="flex space-y-8 w-8/10">
