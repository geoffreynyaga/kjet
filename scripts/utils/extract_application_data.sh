...
# Utility script to quickly extract key information from application PDFs
# Useful for debugging and manual inspection of application data
# Get the project root directory (up two levels from scripts/utils/)
