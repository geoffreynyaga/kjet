...
def main():
    ...
    if args.output_dir:
        ...
        output_path = Path(__file__).resolve().parent.parent.parent / "output-results" / args.cohort / "financial_optimized"
    
    # Create and run evaluator
    evaluator = OptimizedKJETEvaluator(data_path, output_path)
