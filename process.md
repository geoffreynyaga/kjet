This is a project that was first created with one cohort in mind, but then another cohort was given a chance to apply and the problem is that their application data (the application pdf) is slightly modified.
