    ...
    for json_file in sorted(json_files):
        try:
            ...
            for app in data["applications"]:
                ...
                # Additional value chain keywords
                value_chain_keywords = {
                    ...
                    "textiles": ["textile", "cotton", "fabric", "clothing"],
                    "manufacturing": ["manufacturing", "production", "factory"],
                    "technology": ["technology", "tech", "software", "digital"],
                    "retail": ["retail", "shop", "store", "trading"],
                    "services": ["services", "consulting", "training"],
                    "transport": ["transport", "logistics", "delivery"]
                }
...
def main():
    ...
    print("KJET Statistics Generator")
    print("=" * 30)
    ...
    # Generate reports
    text_file = root_dir / "kjet_statistics_report.txt"
    csv_file = root_dir / "kjet_statistics_data.csv"
